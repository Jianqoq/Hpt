...
// 
//     /// used when the conv2d channel not correct
//     #[error("The number of input channels in the image must be equal to the number of input channels in the kernel. expected {0} but got {1}. at {2}")]
//     Conv2dChannelNotMatch(i64, i64, &'static Location<'static>),
// 
...
//         if axis1 == axis2 {
//             return Err(TensorError::SameAxisError(axis1, axis2, Location::caller()));
//         }
//         Ok(())
//     }
// 
...
//             return if index < 0 {
//                 Err(TensorError::IndexOutOfRangeCvt(
//                     ndim,
//                     index,
//                     indedx,
//                     Location::caller(),
//                 ))
//             } else {
//                 Err(TensorError::IndexOutOfRange(ndim, index, Location::caller()))
//             };
//         }
//         Ok(())
//     }
...
//         if size1 != size2 {
//             return Err(TensorError::SizeMismatched(size1, size2, Location::caller()));
//         }
//         Ok(())
//     }
// 
...
//             return Err(TensorError::SizeMismatched(
//                 out_shape.size(),
//                 inplace_layout.size(),
//                 Location::caller(),
//             ));
//         } else if !inplace_layout.is_contiguous() {
//             return Err(TensorError::ContiguousError(
