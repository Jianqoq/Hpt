            ...
            let res =
                ...
                impl SimdCmp<#rhs_simd_ty::#rhs_simd_ty> for #lhs_simd_ty::#lhs_simd_ty {
                    ...
                    fn _eq(self, rhs: #rhs_simd_ty::#rhs_simd_ty) -> Self::Output {
                        paste::paste! {
                            #res_simd_ty::#res_simd_ty(
                               unsafe { std::mem::transmute(self.[<to_ #res_type>]().simd_eq(
                                std::mem::transmute(rhs.[<to_ #res_type>]())
                            )) }
                            )
                        }
                    }
                    fn _ne(self, rhs: #rhs_simd_ty::#rhs_simd_ty) -> Self::Output {
                        paste::paste! {
                            #res_simd_ty::#res_simd_ty(
                            unsafe { std::mem::transmute(self.[<to_ #res_type>]().simd_ne(
                                std::mem::transmute(rhs.[<to_ #res_type>]())
                            )) }
                         )
                        }
                    ...
                    fn _lt(self, rhs: #rhs_simd_ty::#rhs_simd_ty) -> Self::Output {
                        paste::paste! {
                            #res_simd_ty::#res_simd_ty(
                                unsafe { std::mem::transmute(self.[<to_ #res_type>]().simd_lt(
                                    std::mem::transmute(rhs.[<to_ #res_type>]())
                                )) }
                             )
                        }
                    ...
                    fn _le(self, rhs: #rhs_simd_ty::#rhs_simd_ty) -> Self::Output {
                        paste::paste! {
                            #res_simd_ty::#res_simd_ty(
                                unsafe { std::mem::transmute(self.[<to_ #res_type>]().simd_le(
                                    std::mem::transmute(rhs.[<to_ #res_type>]())
                                )) }
                             )
                        }
                    ...
                    fn _gt(self, rhs: #rhs_simd_ty::#rhs_simd_ty) -> Self::Output {
                        paste::paste! {
                            #res_simd_ty::#res_simd_ty(
                                unsafe { std::mem::transmute(self.[<to_ #res_type>]().simd_gt(
                                    std::mem::transmute(rhs.[<to_ #res_type>]())
                                )) }
                             )
                        }
                    ...
                    fn _ge(self, rhs: #rhs_simd_ty::#rhs_simd_ty) -> Self::Output {
                        paste::paste! {
                            #res_simd_ty::#res_simd_ty(
                                unsafe { std::mem::transmute(self.[<to_ #res_type>]().simd_ge(
                                    std::mem::transmute(rhs.[<to_ #res_type>]())
                                )) }
                             )
                        }
