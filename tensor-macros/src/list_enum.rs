...
pub fn list_enums() -> TokenStream2 {
    ...
    let enums: [syn::Expr; 13] = [
        parse_quote! { Dtype::Bool },
        parse_quote! { Dtype::I8 },
        parse_quote! { Dtype::I16 },
        parse_quote! { Dtype::I32 },
        parse_quote! { Dtype::I64 },
        parse_quote! { Dtype::U8 },
        parse_quote! { Dtype::U16 },
        parse_quote! { Dtype::U32 },
        parse_quote! { Dtype::U64 },
        parse_quote! { Dtype::BF16 },
        parse_quote! { Dtype::F16 },
        parse_quote! { Dtype::F32 },
        parse_quote! { Dtype::F64 },
    ];
    let strs = [
        "Bool", "I8", "I16", "I32", "I64", "U8", "U16", "U32", "U64", "BF16", "F16", "F32", "F64",
    ];
