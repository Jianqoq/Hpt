                        ...
                        for m in 0..kernel_width {
                            ...
                            for i in 0..num_vec {
                                unsafe {
                                    ...
                                    for kk in 0..7 {
                                        let inp = T::Vec::from_ptr(&inp[inp_offset + ((k + kk) * step_width + m * dw) * isw + i * T::Vec::SIZE as i64]); // prettier-ignore
                                        out_regs[kk as usize] = kernel_vec.mul_add(inp, out_regs[kk as usize]);
                                    }
