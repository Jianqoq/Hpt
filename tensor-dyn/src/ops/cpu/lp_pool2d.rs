...
fn case1_helper<T, const REGNUM: usize>(
    ...
    inp_cpy: &Pointer<T>,
    mut out: Pointer<T>,
    micro_kernel: fn(i64, i64, i64, i64, <T as TypeCommon>::Vec, &Pointer<T>, &mut [<T as TypeCommon>::Vec; REGNUM])
)
    where
...
fn case3_helper<T, const REGNUM: usize>(
    ...
    fast_micro_kernel: fn(i64, i64, i64, i64, <T as TypeCommon>::Vec, &Pointer<T>, &mut [<T as TypeCommon>::Vec]),
    micro_kernel: fn(i64, i64, i64, i64, i64, <T as TypeCommon>::Vec, &Pointer<T>, &mut Vec<Vec<<T as TypeCommon>::Vec>>),
