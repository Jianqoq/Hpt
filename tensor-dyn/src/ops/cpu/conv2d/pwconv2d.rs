        ...
        bool: IntoScalar<T>
{
    ...
    pub fn pwconv2d(
        ...
        let out_height = (img_height + ph_start + ph_end - 1) / step_height + 1;
        let out_width = (img_width + pw_start + pw_end - 1) / step_width + 1;
        let img = self.clone();
...
fn kernel_params<T: CommonBounds>(
    ...
    let best_params = ic_range
        ...
        .filter_map(|(ic, jb)| {
            ...
            let k_kernel_used = gemm_kernel_used;
            let k_inp_used = gemm_inp_used;
