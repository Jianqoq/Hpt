...
use crate::ops::cpu::kernels::conv_group_kernels::bias_remain_oc_kernel_dispatch;
use crate::ops::cpu::kernels::conv_group_kernels::conv2d_full_oc_bias_kernel_dispatch;
use crate::ops::cpu::kernels::conv_group_kernels::conv2d_full_oc_kernel_dispatch;
use crate::ops::cpu::kernels::conv_group_kernels::remain_oc_kernel_dispatch;
use crate::ops::cpu::kernels::conv_group_kernels::Params;
use crate::ops::cpu::kernels::conv_group_kernels::PartialParams;
                    ...
                    for g in 0..groups {
                        for ii in (0..in_channels_per_group).step_by(ic_block_size) {
                            ...
                            if i_end == in_channels_per_group && has_bias {
                                ...
                                for jj in (0..out_channels_per_group).step_by(
                                    oc_block_size * (jb as usize)
                                ) {
    ...
    for g in 0..groups {
        for ii in (0..in_channels_per_group).step_by(T::Vec::SIZE * ic_nvec) {
            ...
            for jj in (0..out_channels_per_group).step_by(T::Vec::SIZE * oc_nvec * jb) {
                ...
                if remain > 0 {
                    for j in (out_channels_per_group - remain..out_channels_per_group -
                    ...
                    for j in (out_channels_per_group - oc_remain..out_channels_per_group).step_by(
                        T::Vec::SIZE
                    ) {
                        let j = g * out_channels_per_group + j;
                        for n in 0..kh {
