...
impl FloatOutBinary2 for Scalar<Complex64> {
    #[inline(always)]
    fn __div(self, rhs: Self) -> Self {
        Scalar::new(format!("cuCdiv({}, {})", self.val, rhs.val))
    }
...
impl NormalOut2 for Scalar<Complex64> {
    ...
    fn __add(self, rhs: Self) -> Self {
        Scalar::new(format!("cuCadd({}, {})", self.val, rhs.val))
    }

    #[inline(always)]
    fn __sub(self, rhs: Self) -> Self {
        Scalar::new(format!("cuCsub({}, {})", self.val, rhs.val))
    }
    ...
    fn __mul(self, rhs: Self) -> Self {
        Scalar::new(format!("cuCmul({}, {})", self.val, rhs.val))
    }
...
impl NormalOutUnary2 for Scalar<Complex64> {
    #[inline(always)]
    fn __square(self) -> Self {
        Scalar::new(format!("cuCmul({}, {})", self.val, self.val))
    }
    ...
    #[inline(always)]
    fn __neg(self) -> Self {
        Scalar::new(format!("cuCmul({}, make_cuComplex(-1.0, 0.0))", self.val))
    }
...
impl BitWiseOut2 for Scalar<Complex64> {
    #[inline(always)]
    fn __bitand(self, _: Self) -> Self {
        panic!("Bitwise operations are not supported for cuda Complex64")
    }
    ...
    fn __shl(self, _: Self) -> Self {
        panic!("Shift operations are not supported for cuda Complex64")
    }
...
impl Eval2 for Scalar<Complex64> {
    type Output = Scalar<bool>;
    #[inline(always)]
    fn __is_nan(&self) -> Self::Output {
        Scalar::new(format!(
            "(isnan(cuCreal({})) || isnan(cuCimag({})))",
            self.val, self.val
        ))
    }
    ...
    fn __is_true(&self) -> Self::Output {
        Scalar::new(format!(
            "((cuCreal({}) != 0.0 || cuCimag({}) != 0.0) && !isnan(cuCreal({})) && !isnan(cuCimag({})))",
    ...
    fn __is_inf(&self) -> Self::Output {
        Scalar::new(format!(
            "(isinf(cuCreal({})) || isinf(cuCimag({})))",
            self.val, self.val
        ))
    }
}

impl FloatOutUnary2 for Scalar<Complex64> {
    #[inline(always)]
    fn __exp(self) -> Self {
