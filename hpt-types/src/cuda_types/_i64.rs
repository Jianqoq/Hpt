...
impl FloatOutBinary2 for Scalar<i64> {
    #[inline(always)]
    ...
    fn __log(self, _: Self) -> Self {
        panic!("Logarithm operation is not supported for i64")
    }

    #[inline(always)]
    fn __hypot(self, _: Self) -> Self {
        panic!("Hypot operation is not supported for i64")
    }
}

impl NormalOut2 for Scalar<i64> {
    #[inline(always)]
...
impl NormalOutUnary2 for Scalar<i64> {
    #[inline(always)]
...
impl BitWiseOut2 for Scalar<i64> {
    #[inline(always)]
