...
impl FloatOutBinary2 for Scalar<isize> {
    #[inline(always)]
    ...
    fn __log(self, _: Self) -> Self {
        panic!("Logarithm operation is not supported for isize")
    }

    #[inline(always)]
    fn __hypot(self, _: Self) -> Self {
        panic!("Hypot operation is not supported for isize")
    }
}

impl NormalOut2 for Scalar<isize> {
    #[inline(always)]
...
impl NormalOutUnary2 for Scalar<isize> {
    #[inline(always)]
...
impl BitWiseOut2 for Scalar<isize> {
    #[inline(always)]
