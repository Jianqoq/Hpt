...
impl FloatOutBinary2 for Scalar<usize> {
    #[inline(always)]
    ...
    fn __log(self, _: Self) -> Self {
        panic!("Logarithm operation is not supported for usize")
    }

    #[inline(always)]
    fn __hypot(self, _: Self) -> Self {
        panic!("Hypot operation is not supported for usize")
    }
}

impl NormalOut2 for Scalar<usize> {
    #[inline(always)]
...
impl NormalOutUnary2 for Scalar<usize> {
    #[inline(always)]
    ...
    #[inline(always)]
    fn __neg(self) -> Self {
        panic!("Negation operation is not supported for usize")
    }
...
impl BitWiseOut2 for Scalar<usize> {
    #[inline(always)]
