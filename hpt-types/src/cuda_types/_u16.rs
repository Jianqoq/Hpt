...
impl FloatOutBinary2 for Scalar<u16> {
    #[inline(always)]
    ...
    fn __hypot(self, _: Self) -> Self {
        panic!("Hypot operation is not supported for u16")
    }
...
impl NormalOut2 for Scalar<u16> {
    #[inline(always)]
...
impl NormalOutUnary2 for Scalar<u16> {
    #[inline(always)]
    ...
    #[inline(always)]
    fn __neg(self) -> Self {
        panic!("Negation operation is not supported for u16")
    }
...
impl BitWiseOut2 for Scalar<u16> {
    #[inline(always)]
