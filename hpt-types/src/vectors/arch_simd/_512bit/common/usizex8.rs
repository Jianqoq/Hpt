...
#[derive(Clone, Copy, Debug)]
#[repr(C, align(64))]
pub struct usizex8(pub(crate) u64x8);
...
impl std::ops::BitAnd for usizex8 {
    type Output = Self;
    #[inline(always)]
...
impl std::ops::BitOr for usizex8 {
    type Output = Self;
    #[inline(always)]
...
impl std::ops::BitXor for usizex8 {
    type Output = Self;
    #[inline(always)]
...
impl SimdMath<usize> for usizex8 {
    #[inline(always)]
