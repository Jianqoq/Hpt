...
#[allow(non_camel_case_types)]
pub(crate) type f32_promote = f32x16;
...
impl FloatOutBinary2 for f32x16 {
    #[inline(always)]
    ...
    fn __log(self, base: Self) -> Self {
        ...
        f32x16(unsafe { std::mem::transmute(res) })
    }
...
impl NormalOutUnary2 for f32x16 {
    #[inline(always)]
