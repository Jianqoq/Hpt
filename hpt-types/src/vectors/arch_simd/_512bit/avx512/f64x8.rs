...
impl VecTrait<f64> for f64x8 {
    ...
    fn mul_add(self, a: Self, b: Self) -> Self {
        ...
        unsafe {
            f64x8(_mm256_add_pd(_mm256_mul_pd(self.0, a.0), b.0))
        }
        #[cfg(target_feature = "fma")]
        unsafe {
            f64x8(_mm256_fmadd_pd(self.0, a.0, b.0))
        }
    }
    #[inline(always)]
    fn sum(&self) -> f64 {
...
impl SimdCompare for f64x8 {
    ...
    fn simd_eq(self, other: Self) -> Self::SimdMask {
        ...
        unsafe {
            ...
            i64x8(_mm256_set1_epi64x(if mask == 15 { -1 } else { 0 }))
        }
    }
    #[inline(always)]
...
impl Eval2 for f64x8 {
    ...
    fn __is_nan(&self) -> Self::Output {
        unsafe {
            i64x8(std::mem::transmute(_mm256_cmp_pd(
                self.0,
                self.0,
                _CMP_UNORD_Q,
            )))
