...
impl VecTrait<half::f16> for f16x8 {
    ...
    fn _mul_add(self, _: Self, _: Self) -> Self {
        ...
        // let res0 = f32x4_to_f16x4(res0.0);
        // let res1 = f32x4_to_f16x4(res1.0);
...
impl Init<half::f16> for f16x8 {
    ...
    unsafe fn from_ptr(ptr: *const half::f16) -> Self {
        let mut arr = [half::f16::default(); 8];
        arr.copy_from_slice(std::slice::from_raw_parts(ptr, 8));
        f16x8(arr)
    }
}
