...
#[repr(C, align(64))]
pub struct f64x8(pub(crate) __m512d);
...
impl Default for f64x8 {
    #[inline(always)]
    fn default() -> Self {
        unsafe { f64x8(_mm256_setzero_pd()) }
    }
}
...
impl VecTrait<f64> for f64x8 {
    ...
    fn mul_add(self, a: Self, b: Self) -> Self {
        unsafe { f64x8(_mm256_fmadd_pd(self.0, a.0, b.0)) }
    }
    #[inline(always)]
    fn sum(&self) -> f64 {
    ...
    fn splat(val: f64) -> f64x8 {
        unsafe { f64x8(_mm256_set1_pd(val)) }
    }
}
...
impl f64x8 {
    ...
    #[inline(always)]
    pub fn is_nan(&self) -> f64x8 {
        unsafe { f64x8(_mm256_cmp_pd(self.0, self.0, _CMP_UNORD_Q)) }
    }
    ...
    pub fn recip(&self) -> f64x8 {
        unsafe { f64x8(_mm256_div_pd(_mm256_set1_pd(1.0), self.0)) }
    }
}
...
impl SimdSelect<f64x8> for i64x4 {
    #[inline(always)]
    fn select(&self, true_val: f64x8, false_val: f64x8) -> f64x8 {
        unsafe {
            f64x8(_mm256_blendv_pd(
                false_val.0,
                true_val.0,
...
impl std::ops::Add for f64x8 {
    ...
    fn add(self, rhs: Self) -> Self {
        unsafe { f64x8(_mm256_add_pd(self.0, rhs.0)) }
    }
}
impl std::ops::Sub for f64x8 {
    ...
    fn sub(self, rhs: Self) -> Self {
        unsafe { f64x8(_mm256_sub_pd(self.0, rhs.0)) }
    }
}
impl std::ops::Mul for f64x8 {
    ...
    fn mul(self, rhs: Self) -> Self {
        unsafe { f64x8(_mm256_mul_pd(self.0, rhs.0)) }
    }
}
impl std::ops::Div for f64x8 {
    ...
    fn div(self, rhs: Self) -> Self {
        unsafe { f64x8(_mm256_div_pd(self.0, rhs.0)) }
    }
}
...
impl std::ops::Neg for f64x8 {
    ...
    #[inline(always)]
    fn neg(self) -> Self {
        unsafe { f64x8(_mm256_xor_pd(self.0, _mm256_set1_pd(-0.0))) }
    }
}
...
impl SimdMath<f64> for f64x8 {
    ...
    #[inline(always)]
    fn square(self) -> Self {
        f64x8(unsafe { _mm256_mul_pd(self.0, self.0) })
    }
    #[inline(always)]
    fn sqrt(self) -> Self {
    ...
    #[inline(always)]
    fn floor(self) -> Self {
        f64x8(unsafe { _mm256_floor_pd(self.0) })
    }
    #[inline(always)]
    fn ceil(self) -> Self {
        f64x8(unsafe { _mm256_ceil_pd(self.0) })
    }
    #[inline(always)]
    fn neg(self) -> Self {
        f64x8(unsafe { _mm256_sub_pd(_mm256_setzero_pd(), self.0) })
    }
    #[inline(always)]
    fn round(self) -> Self {
    ...
    #[inline(always)]
    fn sign(self) -> Self {
        f64x8(unsafe { _mm256_and_pd(self.0, _mm256_set1_pd(0.0f64)) })
    }
    #[inline(always)]
    ...
    #[inline(always)]
    fn relu(self) -> Self {
        f64x8(unsafe { _mm256_max_pd(self.0, _mm256_setzero_pd()) })
    }
    #[inline(always)]
    fn relu6(self) -> Self {
        f64x8(unsafe { _mm256_min_pd(self.relu().0, _mm256_set1_pd(6.0f64)) })
    }
    #[inline(always)]
