...
impl std::ops::Mul for i64x2 {
    ...
    fn mul(self, rhs: Self) -> Self::Output {
        unsafe {
            ...
            #[cfg(target_arch = "aarch64")]
            return i64x2(vld1q_dup_s64(arr3.as_ptr()));
        }
    }
}
...
impl std::ops::Shr for i64x2 {
    ...
    fn shr(self, rhs: Self) -> Self::Output {
        unsafe {
            ...
            #[cfg(target_arch = "aarch64")]
            return i64x2(vld1q_dup_s64(result.as_ptr()));
        }
    }
}
impl SimdMath<i64> for i64x2 {
    ...
    fn relu(self) -> Self {
        unsafe {
            ...
            #[cfg(target_arch = "aarch64")]
            return i64x2(vld1q_dup_s64(arr2.as_ptr()));
        }
    }
    fn relu6(self) -> Self {
        unsafe {
...
impl VecConvertor for i64x2 {
    ...
    fn to_f64(self) -> super::f64x2::f64x2 {
        unsafe {
            ...
            #[cfg(target_arch = "aarch64")]
            return super::f64x2::f64x2(vld1q_dup_f64(result.as_ptr()));
        }
    }
