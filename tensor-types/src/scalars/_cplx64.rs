...
impl FloatOutBinary2 for Complex64 {
    #[inline(always)]
...
impl NormalOutUnary2 for Complex64 {
    #[inline(always)]
    ...
    #[inline(always)]
    fn __ceil(self) -> Self {
        Complex64::new(self.re.ceil(), self.im.ceil())
    }

    #[inline(always)]
    fn __floor(self) -> Self {
        Complex64::new(self.re.floor(), self.im.floor())
    }
    ...
    fn __round(self) -> Self {
        Complex64::new(self.re.round(), self.im.round())
    }
...
impl BitWiseOut2 for Complex64 {
    #[inline(always)]
    fn __bitand(self, rhs: Self) -> Self {
        Complex64::new(
            f64::from_bits(self.re.to_bits() & rhs.re.to_bits()),
            f64::from_bits(self.im.to_bits() & rhs.im.to_bits()),
        )
    }
    ...
    fn __not(self) -> Self {
        Complex64::new(
            f64::from_bits(!self.re.to_bits()),
            f64::from_bits(!self.im.to_bits()),
        )
    }

    #[inline(always)]
    fn __shl(self, _: Self) -> Self {
        panic!("Shift operations are not supported for Complex64")
    }
...
impl FloatOutUnary2 for Complex64 {
    #[inline(always)]
    fn __exp(self) -> Self {
        self.exp()
    }
