...
impl FloatOutBinary2 for Scalar<i32> {
    #[inline(always)]
...
impl NormalOut2 for Scalar<i32> {
    #[inline(always)]
...
impl NormalOutUnary2 for Scalar<i32> {
    #[inline(always)]
...
impl BitWiseOut2 for Scalar<i32> {
    #[inline(always)]
