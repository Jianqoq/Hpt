...
// sum_square
#define sum_square_bool(a, b) ((bool)((unsigned char)a) + ((unsigned char)b))
#define sum_square_i8(a, b) (a) * (a) + (b) * (b)
#define sum_square_i16(a, b) (a) * (a) + (b) * (b)
#define sum_square_i32(a, b) (a) * (a) + (b) * (b)
#define sum_square_i64(a, b) (a) * (a) + (b) * (b)
#define sum_square_f32(a, b) (a) * (a) + (b) * (b)
#define sum_square_f64(a, b) (a) * (a) + (b) * (b)

#define sum_square_u8(a, b) (a) * (a) + (b) * (b)
#define sum_square_u16(a, b) (a) * (a) + (b) * (b)
#define sum_square_u32(a, b) (a) * (a) + (b) * (b)
#define sum_square_u64(a, b) (a) * (a) + (b) * (b)

#define sum_square_f16(a, b) __hmul((a), (a)) + __hmul((b), (b))
#define sum_square_bf16(a, b) __hmul((a), (a)) + __hmul((b), (b))
