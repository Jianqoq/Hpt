...
#define DEFINE_REDUCE_KERNEL(rust_type, type, INIT_VAL)                                                                                                                                                                        \
    ...
    extern "C" __global__ void nkd_##rust_type(type *out, type *in, long long *out_idx, long long *shape, long long *strides, size_t ndim, size_t cols, size_t num_blocks_per_row)                                             \
    {                                                                                                                                                                                                                          \
        extern __shared__ type sdata_##rust_type[];                                                                                                                                                                            \
        long long *sdata_##rust_type_idx = (long long *)&sdata_##rust_type[blockDim.x];                                                                                                                                        \
        unsigned int tid = threadIdx.x;                                                                                                                                                                                        \
    ...
    extern "C" __global__ void nkd2_##rust_type(type *out, type *in, long long *out_idx, size_t cols, size_t num_blocks_per_row)                                                                                               \
    {                                                                                                                                                                                                                          \
        extern __shared__ type sdata_##rust_type[];                                                                                                                                                                            \
        long long *sdata_##rust_type_idx = (long long *)&sdata_##rust_type[blockDim.x];                                                                                                                                        \
        unsigned int tid = threadIdx.x;                                                                                                                                                                                        \
