...
```json
{
  ...
  "data": {
    ...
    "datasets": [
      ...
      {
        "label": "Hpt (v0.1.2)",
        "data": [41.194, 60.568, 80.626, 99.821, 120.71, 141.04, 162.45, 182.31, 202.99, 222.73, 242.63, 261.52, 280.81, 301.74, 324.06, 343.90, 362.86, 387.07, 403.63, 429.54, 442.86, 463.45, 482.60],
        "backgroundColor": "rgb(25, 181, 243)",
        "borderColor": "rgb(25, 181, 243)",
        "borderWidth": 1
      },
