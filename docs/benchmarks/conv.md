...
```json
{
  ...
  "data": {
    ...
    "datasets": [
      ...
      {
        "label": "Hpt (direct)",
        "data": [10.972, 16.498, 22.311, 28.565, 33.554, 38.697, 44.794, 50.640, 57.125, 64.182, 71.065, 77.754, 84.005, 89.111, 94.859, 103.55, 106.96, 111.74, 118.97, 124.23, 129.94, 136.16, 144.09],
