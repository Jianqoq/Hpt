...
```json
{
  ...
  "data": {
    ...
    "datasets": [
        {
        "label": "Torch (mkldnn + direct)",
        "data": [18.023, 25.794, 33.049, 41.304, 48.821, 56.058, 63.912, 71.418, 78.524, 87.137, 94.035, 101.74, 108.46, 114.30, 119.54, 126.21, 135.99, 150.29, 155.49, 161.87, 172.70, 177.62],
        "backgroundColor": "rgb(255, 99, 133)",
        "borderColor": "rgb(255, 99, 132)",
        "borderWidth": 1
      },
      {
        "label": "Hpt (direct)",
        "data": [12.602, 18.278, 23.997, 29.788, 35.310, 41.075, 47.761, 54.036, 60.597, 66.913, 72.801, 78.695, 84.515, 90.725, 97.012, 103.95, 110.08, 115.81, 123.06, 129.11, 135.18, 141.17],
        "backgroundColor": "rgb(75, 192, 192)",
        "borderColor": "rgb(75, 192, 192)",
        "borderWidth": 1
      },
      {
        "label": "Candle (img2col)",
        "data": [256.75, 279.60, 295.16, 302.47, 321.63, 306.76, 414.31, 352.79, 431.51, 381.27, 513.78, 415.86, 491.64, 445.40, 452.21, 558.14, 501.79, 689.02, 529.97, 629.62, 558.97, 878.95],
        "backgroundColor": "rgba(255, 206, 86)",
        "borderColor": "rgb(255, 206, 86)",
        "borderWidth": 1
      }
