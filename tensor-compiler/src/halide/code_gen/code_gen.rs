...
pub struct CodeGen {
    ...
    pub(crate) module: tensor_llvm::module::module::Module,
    pub(crate) builder: Builder,
    pub(crate) fns: HashMap<Arc<String>, FunctionValue>,
    pub(crate) id_fns: HashMap<usize, FunctionValue>,
    pub(crate) fns_id: HashMap<FunctionValue, usize>,
    pub(crate) bindings: HashMap<usize, ScopeStack>,
    pub(crate) current_fn: usize,
    pub(crate) halide_module: Module,
    pub(crate) tensor_type: StructValue,
    pub(crate) ee: ExecutionEngine,
}
