...
pub mod fma {
    pub mod f32 {
        ...
        microkernel!(["fma"], 1, x1x1, 1, 1);
        microkernel!(["fma"], 1, x1x2, 1, 2);
        microkernel!(["fma"], 1, x1x3, 1, 3);
        microkernel!(["fma"], 1, x1x4, 1, 4);
        microkernel!(["fma"], 1, x1x5, 1, 5);
        microkernel!(["fma"], 1, x1x6, 1, 6);

        microkernel!(["fma"], 1, x2x1, 2, 1);
        microkernel!(["fma"], 1, x2x2, 2, 2);
        microkernel!(["fma"], 1, x2x3, 2, 3);
        microkernel!(["fma"], 1, x2x4, 2, 4);
        microkernel!(["fma"], 1, x2x5, 2, 5);
        microkernel!(["fma"], 1, x2x6, 2, 6);
