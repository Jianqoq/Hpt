...
pub(crate) fn single_thread_matmul_template_no_block_info<T, TVec>(
    a: *const T,
    b: *const T,
    out: *mut T,
    m: usize,
...
pub fn single_thread_matmul<T: 'static>(
    a: *const T,
    b: *const T,
    out: *mut T,
    m: usize,
    ...
    macro_rules! case {
        ($dtype:ty, $vec:ty) => {
            if std::any::TypeId::of::<T>() == std::any::TypeId::of::<$dtype>() {
                single_thread_matmul_template_no_block_info::<$dtype, $vec>(
                    a as *const $dtype,
                    b as *const $dtype,
                    out as *mut $dtype,
                    m,
