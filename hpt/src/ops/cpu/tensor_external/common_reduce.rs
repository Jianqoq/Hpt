...
// impl<T, const DEVICE: usize, Al> NormalReduce<T> for DiffTensor<T, Cpu, DEVICE, Al>
// where
...
// impl<T, const DEVICE: usize, Al> EvalReduce for DiffTensor<T, Cpu, DEVICE, Al>
// where
//     T: CommonBounds + Eval<Output = bool> + Cast<bool>,
//     T::Vec: IntoVec<BoolVector>,
//     Al: Allocator + Send + Sync + 'static,
//     Al::Output: AllocatorOutputRetrive,
// {
//     type BoolOutput = DiffTensor<bool, Cpu, DEVICE, Al>;
//     fn all<S: Into<Axis>>(
//         &self,
//         axes: S,
//         keep_dims: bool,
